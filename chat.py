...
# keyword_responses = {
#     "兽云祭": "“兽云祭”是一个针对兽迷（furry）社区的项目，主要涉及兽图（绘画或插画）的分享和展示，许多机器人插件可以调用兽云祭API来提供随机的兽图或查询特定图像。",
#     "你的主人是谁": "煌秋的主人是筱翯，是一只绿色的龙龙哦，他很聪明一点都不笨",
#     "绿茶龙·筱翯": "绿龙是我的主人！一只羽化鳞龙",
#     "辉龙曦继": "辉龙曦继是一只灰色的龙狼w他拥有操纵风与雷电的能力，而且他是一只强大的精神系的兽兽哦！！",
#     "咲言": "咲言是一只犬科兽兽，身体毛色主体白色，除脸部和肚子部分白色，头顶有蓝色宝石，戴着黄色的心形吊坠，喜欢和小动物打交道，掌握冰系魔法，并且还是冰国皇家兵队，喜欢呆在冰箱里",
#     "筱翯": "筱翯是一只拥有掌控风与光元素的羽化鳞龙，有着修长的身体长长的尾巴，纯白的羽翼以及没有肉垫但却强壮有力的手爪，筱翯是一只实验体，最擅长的是敏捷的战斗。"
# }
